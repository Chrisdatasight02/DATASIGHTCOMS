...
<div class="col-sm-12">
<table id="example" class="table table-striped table-bordered" class="b" cellspacing="0" width="100%"  >
<thead class="alert alert-success">
<tr>
<th>id</th> <th>Salutation</th> <th>First Name</th> <th>Middle Name</th> <th>Last Name</th> <th>Identification number</th> <th>Gender</th> <th>Employment</th> <th>Contact</th> <th>Email</th> <th>Address</th> <th>Vehicle numberplate</th> <th>Purpose</th> <th>Department</th> <th>Date</th> <th>Sign in</th> <th>Sign out</th>
                   <th>Action</th>
                   <th>Action</th>
    </tr>
...
<td><?=$array_data[0]?></td> <td><?=$array_data[1]?></td> <td><?=$array_data[2]?></td> <td><?=$array_data[3]?></td> <td><?=$array_data[4]?></td> <td><?=$array_data[5]?></td> <td><?=$array_data[6]?></td> <td><?=$array_data[7]?></td> <td><?=$array_data[8]?></td> <td><?=$array_data[9]?></td> <td><?=$array_data[10]?></td> <td><?=$array_data[11]?></td> <td><?=$array_data[12]?></td> <td><?=$array_data[13]?></td> <td><?=$array_data[14]?></td> <td><?=$array_data[15]?></td> <td><?=$array_data[16]?></td>

                    <td >
    <a class="btn btn-danger"   href="delete_record.php?id=<?=$array_data[0]?>">Delete</a>
                   </td>

                   <td>
      <a class="btn btn-success" href="edit_record.php?id=<?=$array_data[0]?>">Edit</a>
                   </td>
